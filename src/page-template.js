...
const generateAbout = aboutText => {
    ...
    return `
        <section class="my-3" id="about">
            <h2 class="text-dark bg-primary p-2 dsplay-inline-block">About Me</h2>
            <p>${aboutText}</p>
        </section>
    `
}
...
const generateProjects = projectsArr => {
    // get array of just featured project
    ...
    return `
        <section class='my-3' id='portfolio'>
            <h2 class='text-dark bg-primary p-2 display-inlne-block'>Work</h2>
